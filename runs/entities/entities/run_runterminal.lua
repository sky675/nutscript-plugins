...
if (SERVER) then
	...
	function ENT:Use(activator)
		...
		netstream.Start(activator, "runLoadTerminal", list, false)
	end
else
	function ENT:Draw()
		self:DrawModel()
	...
	function ENT:onDrawEntityInfo(alpha)
		...
		nut.util.drawText("Run Terminal", x, y, ColorAlpha(nut.config.get("color"), alpha), 1, 1, nil, alpha * 0.65)

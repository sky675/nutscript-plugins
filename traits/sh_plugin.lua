...
--migration test
nut.config.add("hasMigratedTrait", false, "DO NOT TOUCH THIS this is how the script determines if traits have been migrated to charvar yet", nil, {
	{category = "zzzzz do not touch"}
})
